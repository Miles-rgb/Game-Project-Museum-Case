...
{    
    ...
    private Vector3 controllerVelocityMomentum;
    ...
    private void ControllerMovement()
    {
        ...
        Vector3 controllerVelocity = (transform.right * horizontal + transform.forward * vertical) * movementSpeed * timeSlowed;
        if (controller.isGrounded)
        {
            controllerVelocityY = -6f;
            if (TestInputJump())
            {                
